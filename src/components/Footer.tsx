...
const Footer = function () {
	return <footer className="h-20 mt-52 mb-8 flex flex-col gap-y-2 items-center">
		<main className='flex gap-x-4'>
			...
			>
				<PiLinkedinLogoDuotone className='text-black dark:text-gray-400 hover:!text-blue-400' size={42} />
			</a>
			<a
				className="decoration-transparent"
				target="_blank"
			...
			>
				<PiGithubLogoDuotone className='text-black dark:text-gray-400 hover:!text-blue-400' size={42} />
			</a>
		</main>
